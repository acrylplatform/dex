...
import com.acrylplatform.dex.error.{Class, Entity, MatcherError}
import com.acrylplatform.dex.meta.DescendantSamples
...
object MatcherErrorDoc {
  ...
  def mkMarkdown: String = {
    val context = new com.acrylplatform.dex.error.ErrorFormatterContext {
