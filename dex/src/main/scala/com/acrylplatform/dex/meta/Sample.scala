package com.acrylplatform.dex.meta
...
import com.acrylplatform.transaction.assets.exchange.{AssetPair, Order, OrderV3}
import shapeless._
...
object Sample {
  ...
  implicit val asset: Sample[Asset]             = mk(Acryl)
