...
import com.acrylplatform.dex.model.ExchangeTransactionCreator._
import com.acrylplatform.dex.settings.AssetType.AssetType
import com.acrylplatform.dex.settings.OrderFeeSettings.PercentSettings
...
object ExchangeTransactionCreator {
  ...
  /**
    ...
    *
    * @see [[com.acrylplatform.transaction.smart.Verifier#verifyExchange verifyExchange]]
    */
