...
import com.acrylplatform.dex.model.Events.ExchangeTransactionCreated
import com.acrylplatform.dex.settings.ExchangeTransactionBroadcastSettings
...
import com.acrylplatform.transaction.assets.exchange.{AssetPair, ExchangeTransaction, ExchangeTransactionV2, Order}
...
class ExchangeTransactionBroadcastActorSpecification
  ...
  private val pair = AssetPair(IssuedAsset(Array.emptyByteArray), Acryl)
