package com.acrylplatform.dex.matching
...
import com.acrylplatform.dex.market.MatcherSpecLike
import com.acrylplatform.dex.model.Events.{OrderAdded, OrderExecuted}
import com.acrylplatform.dex.model.{LimitOrder, OrderHistoryStub}
import com.acrylplatform.dex.{AssetPairDecimals, MatcherTestData, _}
...
class ReservedBalanceSpecification
  ...
  val pair = AssetPair(mkAssetId("ACRYL"), mkAssetId("USD"))
